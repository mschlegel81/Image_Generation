...
PROCEDURE T_imageManipulationStep.execute(CONST previewMode,retainStashesAfterLastUse: boolean; CONST inWorkflow:P_imageManipulationWorkflow; CONST inQueue:P_progressEstimatorQueue; VAR targetImage:T_rawImage);
  ...
  begin
    ...
    case imageManipulationType of
      ...
      imt_fillRotate: if plausibleResolution then targetImage.resize(param.i0,param.i1,res_cropRotate);
      imt_fitRotate : if plausibleResolution then targetImage.resize(param.i0,param.i1,res_fitRotate);
      ...
      imt_modMed: targetImage.modMedFilter(inQueue);
